...
const sortByPrice = sortByPrice(marketplace);
...
const filteredByPrice = marketplace.filter(marketplace => marketplace.price >= 50 && marketplace.price <= 100);
...
let averagePrice = totalPrice/marketplace.length;
